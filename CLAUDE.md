<!-- SPECKIT START -->
**Active feature**: none — 033 (math-assumptions-cleanup) merged to main 2026-06-06. Next candidates: BACKLOG B-033-1/2/3 (LTCG gross-up on the funding ladder's brokerage rung; user-facing `cashRealReturn` input; signed-endBalance check for Safe/Exact gates), or X1 Monte Carlo / sequence-of-returns (design input already folded in).
