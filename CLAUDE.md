<!-- SPECKIT START -->
**Active feature**: 029 (withdrawal-spend-parity) — **IMPLEMENTATION COMPLETE — AWAITING BROWSER SMOKE** on branch `029-withdrawal-spend-parity` (2026-05-11). Three-layer fix shipped: (1) **Bug A** — `_simulateStrategyLifetime` now composes `grossSpend = retireSpend + hcDelta + collegeCostThisYear` (typeof-guarded for sandbox safety) so the per-strategy simulator matches `computeWithdrawalStrategy` / `projectFullLifecycle` during overlay-spend years (kid college, pre-65 healthcare). Withdrawal Strategy chart bars and strategy ranker now reflect actual annual outflow. (2) **Bug B** — `_invariantA` gated to suppress `endBalance-mismatch` warning when both sims agree on feasibility verdict AND no strategyMismatch (clamping-artifact noise filter; the genuine bug class — verdict disagreement — still fires). (3) **US4** — new `_invariantE` (`simulator-grossSpend-parity`) audit invariant added; compares per-age `grossSpend` across simulators via opt-in `ctx.simulatorTraces` array; structural unit tests pin behavior; pipeline-side trace wiring deferred to follow-up. **Tests**: 548/548 unit (528 baseline + 12 Bug A + 8 Invariant E pins; T7 updated for Bug B suppression). E2E: 0 regressions from feature 029 (the 10 failures observed are pre-existing on `main` — confirmed via stash + checkout audit). Constitution check: PASS on all 9 principles, no Complexity Tracking entries. **Lockstep audit: RR +14 / Generic +14, 0-line delta** (byte-identical edits to both HTMLs). Merge gate: T031 manual browser smoke per CLAUDE.md (verify bar at Roger 57 ~$184K nominal vs pre-fix $132K; confirm zero `endBalance-mismatch` warnings on default fixture; cycle Mode×Objective; toggle EN↔中文). Spec [`spec.md`](./specs/029-withdrawal-spend-parity/spec.md), Plan [`plan.md`](./specs/029-withdrawal-spend-parity/plan.md), Research [`research.md`](./specs/029-withdrawal-spend-parity/research.md), Data Model [`data-model.md`](./specs/029-withdrawal-spend-parity/data-model.md), Contract [`contracts/grossSpend-parity.contract.md`](./specs/029-withdrawal-spend-parity/contracts/grossSpend-parity.contract.md), Quickstart [`quickstart.md`](./specs/029-withdrawal-spend-parity/quickstart.md), Closeout [`CLOSEOUT.md`](./specs/029-withdrawal-spend-parity/CLOSEOUT.md). Predecessor 028 (strategy-aware-fire-age) merged to main 2026-05-11 via merge commit `7cc84ce`.

- Constitution: [.specify/memory/constitution.md](./.specify/memory/constitution.md)
- Backlog: [BACKLOG.md](./BACKLOG.md)
- Predecessor features: [specs/001-modular-calc-engine/CLOSEOUT.md](./specs/001-modular-calc-engine/CLOSEOUT.md), [specs/002-inline-bugfix/](./specs/002-inline-bugfix/), [specs/003-browser-smoke-harness/](./specs/003-browser-smoke-harness/), [specs/004-html-canonical-swap/ABANDONED.md](./specs/004-html-canonical-swap/ABANDONED.md), [specs/005-canonical-public-launch/CLOSEOUT.md](./specs/005-canonical-public-launch/CLOSEOUT.md), [specs/006-ui-noise-reset-lifecycle-dock/CLOSEOUT.md](./specs/006-ui-noise-reset-lifecycle-dock/CLOSEOUT.md), [specs/007-bracket-fill-tax-smoothing/CLOSEOUT.md](./specs/007-bracket-fill-tax-smoothing/CLOSEOUT.md), [specs/008-multi-strategy-withdrawal-optimizer/](./specs/008-multi-strategy-withdrawal-optimizer/), [specs/009-single-person-mode/](./specs/009-single-person-mode/), [specs/010-country-budget-scaling/](./specs/010-country-budget-scaling/), [specs/011-responsive-header-fixes/](./specs/011-responsive-header-fixes/), [specs/012-ssa-earnings-pre-2020/](./specs/012-ssa-earnings-pre-2020/), [specs/013-tabbed-navigation/](./specs/013-tabbed-navigation/), [specs/014-calc-audit/](./specs/014-calc-audit/), [specs/015-calc-debt-cleanup/](./specs/015-calc-debt-cleanup/), [specs/016-mortgage-payoff-vs-invest/CLOSEOUT.md](./specs/016-mortgage-payoff-vs-invest/CLOSEOUT.md), [specs/017-payoff-vs-invest-stages-and-lumpsum/CLOSEOUT.md](./specs/017-payoff-vs-invest-stages-and-lumpsum/CLOSEOUT.md), [specs/018-lifecycle-payoff-merge/CLOSEOUT.md](./specs/018-lifecycle-payoff-merge/CLOSEOUT.md), [specs/019-accumulation-drift-fix/](./specs/019-accumulation-drift-fix/), [specs/020-validation-audit/CLOSEOUT.md](./specs/020-validation-audit/CLOSEOUT.md), [specs/021-tax-category-and-audit-cleanup/CLOSEOUT.md](./specs/021-tax-category-and-audit-cleanup/CLOSEOUT.md), [specs/022-nominal-dollar-display/CLOSEOUT.md](./specs/022-nominal-dollar-display/CLOSEOUT.md), [specs/023-accumulation-spend-separation/CLOSEOUT.md](./specs/023-accumulation-spend-separation/CLOSEOUT.md), [specs/024-deferred-fixes-cleanup/CLOSEOUT.md](./specs/024-deferred-fixes-cleanup/CLOSEOUT.md), [specs/025-family-financial-vault/CLOSEOUT.md](./specs/025-family-financial-vault/CLOSEOUT.md), [specs/026-withdrawal-tax-and-ui-fixes/CLOSEOUT.md](./specs/026-withdrawal-tax-and-ui-fixes/CLOSEOUT.md), [specs/027-aggressive-bracket-fill/CLOSEOUT.md](./specs/027-aggressive-bracket-fill/CLOSEOUT.md), [specs/028-strategy-aware-fire-age/CLOSEOUT.md](./specs/028-strategy-aware-fire-age/CLOSEOUT.md)
<!-- SPECKIT END -->
