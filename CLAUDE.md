<!-- SPECKIT START -->
**Active feature**: 021 (tax-category-and-audit-cleanup) — **AWAITING USER BROWSER-SMOKE (T088) before merge to `main`**. All 92 implementation tasks complete (Phases 1–10, US7 deferred to feature 022). Tests: **450 passing, 1 intentional skip, 0 failures** (was 414 baseline + 36 net new). **0 CRITICAL findings ✓ · 0 HIGH findings ✓ (SC-009 fully satisfied for first time since feature 020 audit)**. 17 LOW findings carried to B-021-1 (simulator-discreteness fix bundled with B-021-2 US7 fractional-year DWZ for feature 022). Constitution VIII gate green. Spec [`spec.md`](./specs/021-tax-category-and-audit-cleanup/spec.md), Plan [`plan.md`](./specs/021-tax-category-and-audit-cleanup/plan.md), Tasks [`tasks.md`](./specs/021-tax-category-and-audit-cleanup/tasks.md), Audit Report [`audit-report.md`](./specs/021-tax-category-and-audit-cleanup/audit-report.md), CLOSEOUT [`CLOSEOUT.md`](./specs/021-tax-category-and-audit-cleanup/CLOSEOUT.md). Predecessor 020 merged to main 2026-05-01 (commit `3d45eab`).
